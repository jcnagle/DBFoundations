...
-- 2022-11-20,JuliaNagle,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_JuliaNagle')
	 Begin 
	  Alter Database [Assignment06DB_JuliaNagle] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_JuliaNagle;
	 End
	Create Database Assignment06DB_JuliaNagle;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_JuliaNagle;
...
AS
SELECT TOP 1000000000 vCategories.CategoryID
	, CategoryName
	, vProducts.ProductID
	, ProductName
	, UnitPrice
